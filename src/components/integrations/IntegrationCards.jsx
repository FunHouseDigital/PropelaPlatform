...
import { Puzzle, Wifi, WifiOff, RefreshCw, ChevronDown, ChevronUp, Clock, CheckCircle, XCircle } from 'lucide-react';
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-md text-xs font-mono bg-white focus:ring-2 focus:ring-[#5B2D8E]/20 focus:border-[#5B2D8E] outline-none"
